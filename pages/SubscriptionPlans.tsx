    ...
    const plans = [
        {
            ...
            features: [
                ...
                { name: 'E-commerce Store Builder', included: false },
                { name: 'Zapier & Webhook Integration', included: false },
        ...
        },
        {
            ...
            popular: true,
            features: [
                { name: '10,000 Active Subscribers', included: true },
                { name: 'Unlimited Flows & Broadcasts', included: true },
                { name: '5 Connected Facebook Pages', included: true },
                { name: 'Advanced Comment Growth Tools', included: true },
                { name: 'E-commerce Store (Products, Orders, Payments)', included: true },
                ...
                { name: 'Team Members Access', included: false },
                { name: 'White Label Domain', included: false },
            ]
        },
        {
            name: 'Enterprise',
            price: billingCycle === 'monthly' ? 199 : 1990,
            description: 'Complete dominance with unlimited scale & white-label',
            icon: Shield,
            color: 'indigo',
            features: [
                { name: 'Unlimited Active Subscribers', included: true },
                { name: 'Unlimited Connected Pages', included: true },
                { name: 'Unlimited E-commerce Stores', included: true },
                { name: 'White Label (Custom Domain)', included: true },
                { name: 'Team Member & Role Management', included: true },
                { name: 'Affiliate Program Access', included: true },
                { name: 'Priority 24/7 Dedicated Support', included: true },
                { name: 'Advanced Analytics & Pixel Tracking', included: true },
                { name: 'Custom Integration Setup', included: true },
                { name: 'AI Smart Auto-Responses', included: true },
                { name: 'Bot Templates Library Access', included: true },
            ]
        }
    ];
