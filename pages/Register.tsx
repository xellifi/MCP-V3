...
const Register: React.FC<RegisterProps> = ({ onLogin }) => {
  ...
  return (
    <div className="h-screen py-[10px] bg-slate-950 flex flex-col items-center justify-center relative overflow-hidden">
      {/* Cosmic Background */}
      ...
      <div className="w-full max-w-md relative z-10 glass-panel rounded-3xl overflow-hidden animate-fade-in-up border border-white/10 shadow-2xl flex flex-col max-h-full">
        <div className="p-8 pb-4 text-center shrink-0">
          ...
          <p className="text-sm text-slate-400">Start automating your business today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 flex-1 overflow-y-auto no-scrollbar">
            ...
            <div>
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <UserIcon className="h-4 w-4 text-slate-500 group-focus-within:text-indigo-400 transition-colors" />
                </div>
                <input
                  type="text"
                  value={name}
                  onChange={e => setName(e.target.value)}
                  className="w-full bg-white/5 border border-slate-700/50 rounded-lg pl-10 pr-4 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 outline-none transition-all text-white placeholder-slate-600"
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 py-2.5 px-4 bg-white hover:bg-slate-100 text-slate-900 font-medium rounded-lg transition-all border border-slate-300 text-sm"
            >
