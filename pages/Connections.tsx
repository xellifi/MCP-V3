...
const Connections: React.FC<ConnectionsProps> = ({ workspace }) => {
  ...
  const handleConnect = async () => {
    try {
      ...
      const scope = encodeURIComponent('email,public_profile,pages_show_list,pages_read_engagement,pages_read_user_content,pages_manage_engagement,pages_manage_metadata,pages_manage_posts,pages_messaging,read_insights,business_management,instagram_basic,instagram_manage_comments');
