-- ============================================
-- SUPABASE SCHEMA FOR MyChatPilot
-- Run this in Supabase SQL Editor
-- ============================================

-- 1. PROFILES TABLE (Required for user authentication)
...
-- 3. ADMIN SETTINGS TABLE (For Facebook App credentials)
...
-- Policy: Only admins can read/write admin_settings
...
-- ============================================
-- DONE! Now create your admin user in Authentication
-- ============================================
