...
const VisualToolNode = ({ data }: { data: any }) => {
    return (
        <div className="relative group flex flex-col items-center !bg-transparent" style={{ background: 'transparent', borderRadius: '50%' }}>
            ...
            <div className="w-20 h-20 bg-slate-900 border-2 border-slate-600 rounded-full shadow-lg flex flex-col items-center justify-center gap-1 transition-all hover:scale-105 hover:shadow-indigo-500/20 relative z-0 overflow-hidden">
            ...
            <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 w-48 text-center">
                <span className="font-bold text-slate-400 text-xs text-center leading-tight block">Jira<br />Software</span>
            </div>
        </div>
    );
};

export default memo(VisualToolNode);
