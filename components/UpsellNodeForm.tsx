...
const UpsellNodeForm: React.FC<UpsellNodeFormProps> = ({
    ...
    ), [activeSection, headline, headlineColor, showEmoji, emojiType, imageSource, imageUrl, isUploading, uploadError, imageBorderRadius, imageBorderWidth, imageBorderColor, price, priceBadgeColor, priceTextColor, description, descriptionColor, buttonText, showButtonIcon, buttonBorderRadius, buttonBgColor, buttonTextColor, backgroundColor, cartAction, productName]);
