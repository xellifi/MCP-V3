...
const CommentReplyNodeForm: React.FC<CommentReplyNodeFormProps> = ({
    ...
    useEffect(() => {
        ...
        if (initialConfig) {
            ...
            setAiPrompt(initialConfig.aiPrompt || 'Generate a friendly and helpful reply to this comment');
        }
    }, [initialConfig]);
            ...
            <div>
                ...
                <div className="mt-2 space-y-1">
                    ...
                    <p className="text-xs text-indigo-300 mt-2">
                        Example: "Hi {'{commenter_name}'}, thanks for saying '{'{comment_text}'}' on {'{page_name}'}!"
                    </p>
                </div>
            </div>
