...
const TriggerNodeForm: React.FC<TriggerNodeFormProps> = ({
    ...
    const [enableAutoReact, setEnableAutoReact] = useState(initialConfig?.enableAutoReact !== undefined ? initialConfig.enableAutoReact : true);
    ...
    useEffect(() => {
        if (initialConfig) {
            ...
            setEnableAutoReact(initialConfig.enableAutoReact !== undefined ? initialConfig.enableAutoReact : true);
        }
    ...
    useEffect(() => {
        ...
        const configKey = `${selectedPageId}-${enableCommentReply}-${enableSendMessage}-${enableAutoReact}`;
    ...
    }, [selectedPageId, enableCommentReply, enableSendMessage, enableAutoReact]);
