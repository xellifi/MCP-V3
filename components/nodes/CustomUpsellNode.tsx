...
import { ChevronDown, ChevronUp, DollarSign, ShoppingCart, ArrowUp, ShoppingBag, Loader, CheckCircle, XCircle } from 'lucide-react';
        ...
        <div className="relative group">
            ...
            >
                ...
                {isExecuting && (
                    <>
                        <div className="absolute w-3 h-3 rounded-full bg-blue-400 shadow-[0_0_15px_#3b82f6,0_0_30px_#3b82f6] z-[100]"
                            style={{ top: '-6px', animation: 'orbTopUpsell 2s linear infinite' }} />
                        <div className="absolute w-3 h-3 rounded-full bg-blue-400 shadow-[0_0_15px_#3b82f6,0_0_30px_#3b82f6] z-[100]"
                            style={{ bottom: '-6px', animation: 'orbBottomUpsell 2s linear infinite' }} />
                        <style>{`
                            @keyframes orbTopUpsell { 0% { left: -6px; } 100% { left: calc(100% - 6px); } }
                            @keyframes orbBottomUpsell { 0% { left: -6px; } 100% { left: calc(100% - 6px); } }
                        `}</style>
                    </>
                )}
                ...
                <div className="flex items-center gap-2">
                    <div className={`p-2 rounded-lg backdrop-blur-sm flex-shrink-0 relative ${isError ? 'bg-red-500' : isExecuting ? 'bg-blue-500' : isCompleted ? 'bg-emerald-500' : 'bg-emerald-500/20'}`}>
                        {isError ? (
                            ...
                            <>
                                ...
                                <ArrowUp className="w-2.5 h-2.5 text-white absolute -bottom-0.5 -right-0.5 bg-emerald-600 rounded-full p-0.5" />
                            </>
                        )}
                    </div>
