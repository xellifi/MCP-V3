                        ...
                        {data.buttons && data.buttons.length > 0 && (
                            <div className="mt-2 space-y-1.5">
                                ...
                                {data.buttons.map((btn: any, index: number) => (
                                    <div
                                        key={index}
                                        className="flex items-center gap-2 px-2.5 py-1.5 bg-blue-500/20 border border-blue-500/30 rounded-lg"
                                    >
                                        <span className="text-blue-300 text-xs font-medium truncate flex-1">
                                            {btn.title || 'Untitled'}
                                        </span>
                                        {btn.webviewHeight && (
